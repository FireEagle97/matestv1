                ...
                <div class="col-lg-5 col-md-8 col-11 align-self-center">
                    <div class="user-login-card card my-5">
                        <div class="text-center auth-heading">
                            ...
                            <h5>{{ __('Producer Login') }}</h5>
                            <p class="fs-14">{{ __('Sign in to manage your movies and earnings.') }}</p>
                            @if (session()->has('error'))
                                <span class="text-danger">{{ session()->get('error') }}</span>
                            @endif
                        </div>
                        <p class="text-danger" id="login_error_message"></p>
                        <form method="POST" action="{{ route('producer.login.submit') }}" id="login-form" class="requires-validation" data-toggle="validator" novalidate>
                            @csrf
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text px-0" id="togglePassword"> <i class="ph ph-eye-slash"></i></span>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                ...
                                <a href="{{route('forget-password')}}" >{{__('frontend.forgot_password')}}</a>
                            </div>
